...
from ui.vigenere import Ui_Vigenere  # Nếu bạn đổi tên, ví dụ Ui_Vigenere thì sửa lại cho đúng
import requests
...
class MyApp(QMainWindow):
    ...
    def call_api_encrypt(self):
        url = "http://127.0.0.1:5001/api/vigenere/encrypt"
        payload = {
    ...
    def call_api_decrypt(self):
        url = "http://127.0.0.1:5001/api/vigenere/decrypt"
        payload = {
